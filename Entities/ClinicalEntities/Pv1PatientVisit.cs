...
public partial class Pv1PatientVisit
{
    ...
    public string? Pv163PriorPatientLocationFacility { get; set; }

    public string? Pv164PriorPatientLocationLocationStatus { get; set; }

    public string? Pv165PriorPatientLocationPersonLocationType { get; set; }

    public string? Pv166PriorPatientLocationBuilding { get; set; }

    public string? Pv167PriorPatientLocationFloor { get; set; }

    public string? Pv168PriorPatientLocationLocationDescription { get; set; }
    ...
    public string? Pv1441AdmitDateTimeDegreeOfPrecision { get; set; }
