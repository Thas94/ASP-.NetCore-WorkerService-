...
public partial class VwImtlatestCaseStatesWithAdmissionDetail
{
    ...
    public long LatestCaseStatesIdL { get; set; }

    public string CaseNumberL { get; set; } = null!;

    public bool PatientCurrentlyAdmittedL { get; set; }

    public string? PatientLocationPointOfCareL { get; set; }

    public string? WardDescriptionL { get; set; }
}
